...
inline fun addressBook(block: com.example.demo.protobuf.entity.AddressBookKt.Dsl.() -> kotlin.Unit): com.example.demo.protobuf.entity.User.AddressBook =
  com.example.demo.protobuf.entity.AddressBookKt.Dsl._create(com.example.demo.protobuf.entity.User.AddressBook.newBuilder()).apply { block() }._build()
object AddressBookKt {
  ...
  class Dsl private constructor(
    ...
    inline operator fun com.google.protobuf.kotlin.DslList<com.example.demo.protobuf.entity.User.Person, PeopleProxy>.plusAssign(value: com.example.demo.protobuf.entity.User.Person) {
      add(value)
    }
    /**
     * <code>repeated .tutorial.Person people = 1;</code>
    ...
    @Suppress("NOTHING_TO_INLINE")
    inline operator fun com.google.protobuf.kotlin.DslList<com.example.demo.protobuf.entity.User.Person, PeopleProxy>.plusAssign(values: kotlin.collections.Iterable<com.example.demo.protobuf.entity.User.Person>) {
      addAll(values)
    }
    /**
     * <code>repeated .tutorial.Person people = 1;</code>
    ...
    operator fun com.google.protobuf.kotlin.DslList<com.example.demo.protobuf.entity.User.Person, PeopleProxy>.set(index: kotlin.Int, value: com.example.demo.protobuf.entity.User.Person) {
